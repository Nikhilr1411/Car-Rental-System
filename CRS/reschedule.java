...
{
    JFrame f = new JFrame("RESCHEDULE");
    JButton b,b2,b3;
    JLabel l1,l2;
    JComboBox cb,cb1,cb2,cb3,cb4,cb5,cb6;
    public reschedule(String str,String mail)
    {
        ...
        cb = new JComboBox();
        cb.addItem("Select car");
        cb.setBounds(200, 300, 320, 20);
        b = new JButton("OK");
        b.setBounds(200, 350, 80, 20);
        ...
        String temp = "C:\\Users\\Nikhil\\OneDrive\\Desktop\\registration2.csv";
        b3 = new JButton("Back");
        ...
        b2.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e)
            {
                ...
                {
                    f.dispose();
                    JFrame f1 = new JFrame("RESCHEDULE");
                    JPanel tp, cp, bp;
                    JLabel label;
                    JTextField tf;
                    JButton b;
                        ...
                        b.addActionListener(new ActionListener() {
                            ...
                            public void actionPerformed(ActionEvent e)
                            {
                                try
                                {
                                    ...
                                    while ((l1 = bb.readLine()) != null)
                                    {
                                        String[] details = l1.split(",");
                                        if (details[0].equals(str))
                                        {
                                            fw.write(id + "," + mail + "," + regno + "," + cb3.getSelectedItem()+ "-" + month + "-" + cb1.getSelectedItem() + "," +
                                                    cb6.getSelectedItem() + "-" + month1 + "-" + cb4.getSelectedItem()+ "," + "booked\n");
                                        }
                                        else
                                        {
                                            fw.write(details[0] + "," + details[1] + "," + details[2] + "," + details[3] + "," + details[4] + "," + details[5] + "\n");
                                        }
                                    }
                                    fw.close();
                                    bb.close();
                                    BufferedReader b1 = new BufferedReader(new FileReader(temp));
                                    ...
                                    w.close();
                                    f1.dispose();
                                    JFrame f2 = new JFrame("Rescheduled");
